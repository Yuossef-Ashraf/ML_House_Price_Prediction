"""
Production Machine Learning Pipeline for Residential Real Estate Valuation & Price Prediction.
...
def train_and_evaluate(csv_path: str = "predicting house price.csv"):
...
def main():
    parser = argparse.ArgumentParser(description="Residential Real Estate Valuation & Price Prediction CLI")
    parser.add_argument("--data", type=str, default="predicting house price.csv", help="Path to CSV dataset")
